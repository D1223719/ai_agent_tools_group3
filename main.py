...
from tools import get_city_weather, read_pdf_content, read_code_files, get_travel_advice
...
def main():
    ...
    model_kwargs = {
        ...
        "tools": [get_city_weather, read_pdf_content, read_code_files, get_travel_advice]
    }
